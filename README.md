...
当前发布版本：`0.1.0-beta.5`。第一期仅支持 macOS Apple Silicon，属于小范围 Beta，请在重要使用前保留原始音频。
...
```bash
tar -xzf audio-memory-v0.1.0-beta.5-macos-arm64.tar.gz
cd audio-memory-v0.1.0-beta.5
